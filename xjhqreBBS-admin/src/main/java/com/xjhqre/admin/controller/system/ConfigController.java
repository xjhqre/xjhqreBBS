...
public class ConfigController extends BaseController {
    ...
    public R<IPage<Config>> listConfig(Config config, @PathVariable("pageNum") Integer pageNum,
        ...
        return R.success(this.configService.listConfig(config, pageNum, pageSize));
    }
    ...
    public R<Config> getInfo(@PathVariable Long configId) {
        return R.success(this.configService.selectConfigById(configId));
    }
    ...
    public R<String> add(@Validated @RequestBody Config config) {
        if (Constants.NOT_UNIQUE.equals(this.configService.checkConfigKeyUnique(config))) {
