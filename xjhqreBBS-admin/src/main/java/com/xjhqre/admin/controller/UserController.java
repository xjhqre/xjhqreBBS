...
public class UserController extends BaseController {
    ...
    public R<IPage<UserVO>> findUser(UserDTO userDTO, @PathVariable("size") Integer size,
        @PathVariable("current") Integer current) {
        return R.success(this.userService.findUser(userDTO, current, size));
    }
    ...
    public R<String> addUser(User user) {
        ...
        if (hasSameEmail) {
            throw new MyServiceException(ErrorEnume.EMAIL_DUPLICATE);
        }
        // 查找是否有重名用户
