package com.xjhqre.portal.security.config;
...
import com.xjhqre.portal.security.filter.JwtAuthenticationTokenFilter;
import com.xjhqre.portal.security.handle.AuthenticationEntryPointImpl;
import com.xjhqre.portal.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
            ...
            .antMatchers("/portal/login", "/portal/register", "/captchaImage", "/sendEmail").anonymous()
            // 静态资源，可匿名访问
