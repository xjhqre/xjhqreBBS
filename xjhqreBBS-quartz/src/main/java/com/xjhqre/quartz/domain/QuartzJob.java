...
public class QuartzJob extends BaseEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("jobId", this.getJobId())
            .append("jobName", this.getJobName()).append("jobGroup", this.getJobGroup())
            .append("cronExpression", this.getCronExpression()).append("nextValidTime", this.getNextValidTime())
            .append("misfirePolicy", this.getMisfirePolicy()).append("concurrent", this.getConcurrent())
            .append("status", this.getStatus()).append("createBy", this.getCreateBy())
